...
use Illuminate\Clover\Collection;
use Illuminate\Clover\Interfaces\Http\EnvironmentInterface;

/**
 * Environment
 *
 * This class decouples the Clovers application from the global PHP environment.
...
class Environment extends Collection implements EnvironmentInterface
{
    ...
    public static function mock(array $userData = [])
    {
        $data = array_merge([
            ...
            'HTTP_USER_AGENT'      => 'Clovers Framework',
